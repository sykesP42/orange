...
const bannerStyle = computed(() => {
  ...
  return { background: team.value?.color || '#6366f1' }
})
...
const getUserColor = (user) => {
  const colors = ['#ff6b35', '#6366f1', '#10b981', '#f59e0b', '#ef4444', '#8b5cf6', '#ec4899', '#14b8a6']
...
const loadTeamBloggerStats = async () => {
  try {
    ...
    console.error('加载博主统计数据失败', error)
  }
}
