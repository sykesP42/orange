    ...
    <div v-if="selectedPost" class="modal-overlay" style="background:rgba(0,0,0,0.6)!important;backdrop-filter:blur(4px);" @click.self="closePost">
      <div class="modal" style="background:var(--bg-card);max-width:640px;">
        ...
        <div class="detail-body">
          <div class="post-meta">
            <div class="author-avatar" :style="{ backgroundColor: selectedPost.author_color || '#6366f1' }">
...
const canPost = computed(() => !!userStore.userId)
const isAdmin = computed(() => userStore.role === 'admin')
const canDelete = computed(() => {
  if (!selectedPost.value || !userStore.userId) return false
  return selectedPost.value.author_id === userStore.userId || userStore.role === 'admin'
})
